<<<<<<< HEAD:html/Página Incidencias.php
<?php
...
<header class="Encabezado" role="banner">
  ...
  <nav id="menu"><a id="Logo" href="../index.html"><img src="../img/logo.svg"
    ...
    <div id="iconosBanner">
      <a id="Login" href="../html/login.html">
        <img id="iconoLogin" src="../img/perfilLogin.svg" alt="Perfil Log In">
      </a>
      <div class="hamburguesa">
        <div></div>
        <div></div>
...
>>>>>>> César:html/Página Incidencias.html
</html>